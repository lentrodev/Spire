...
namespace Spire.Core.Markups
{
    ...
    public abstract class KeyboardMarkupBuilderBase<TKeyboardMarkup, TKeyboardMarkupButton, TKeyboardMarkupRowBuilder, TKeyboardMarkupBuildOptions> : IKeyboardMarkupBuilder<TKeyboardMarkup, TKeyboardMarkupButton, TKeyboardMarkupRowBuilder, TKeyboardMarkupBuildOptions> 
        ...
        where TKeyboardMarkupRowBuilder : IKeyboardMarkupRowBuilder<TKeyboardMarkupRowBuilder, TKeyboardMarkup, TKeyboardMarkupButton>, new()
    {
        ...
        /// <returns>Configured keyboard markup builder.</returns>
        public IKeyboardMarkupBuilder<TKeyboardMarkup, TKeyboardMarkupButton, TKeyboardMarkupRowBuilder, TKeyboardMarkupBuildOptions> WithRow(Action<TKeyboardMarkupRowBuilder> configureRow)
        {
        ...
        /// <returns>Configured keyboard markup builder.</returns>
        public IKeyboardMarkupBuilder<TKeyboardMarkup, TKeyboardMarkupButton, TKeyboardMarkupRowBuilder, TKeyboardMarkupBuildOptions> Combine(IKeyboardMarkupBuilder<TKeyboardMarkup, TKeyboardMarkupButton, TKeyboardMarkupRowBuilder, TKeyboardMarkupBuildOptions> keyboardMarkupBuilder)
        {
        ...
        protected abstract IEnumerable<IEnumerable<TKeyboardMarkupButton>> DeconstructMarkup(TKeyboardMarkup keyboardMarkup);
        
        protected abstract TKeyboardMarkup BuildMarkup(IEnumerable<IEnumerable<TKeyboardMarkupButton>> markupKeyboard, TKeyboardMarkupBuildOptions keyboardMarkupBuildOptions = default);
        ...
        public TKeyboardMarkup Build(TKeyboardMarkupBuildOptions keyboardMarkupBuildOptions = default)
        {
            ...
            {
                throw new InvalidOperationException($"You can't new button(s) to the keyboard markup. Buttons count can't exceed {_keyboardMarkupSizeLimit.Buttons}.");
            }
            if (_keyboardMarkupButtons.Count > _keyboardMarkupSizeLimit.Rows)
            {
                throw new InvalidOperationException($"You can't add a new row to the keyboard markup. Rows count can't exceed {_keyboardMarkupSizeLimit.Rows}.");
            }
            if(_keyboardMarkupButtons.Max(row => row.Count()) > _keyboardMarkupSizeLimit.Columns)
            {
                throw new InvalidOperationException($"You can't add a new column to the keyboard markup. Columns count can't exceed {_keyboardMarkupSizeLimit.Columns}.");
            }
