...
namespace Spire.Core.Markups.Inline
{
    ...
    /// </summary>
    public class InlineKeyboardMarkupBuilder : KeyboardMarkupBuilderBase<InlineKeyboardMarkup, InlineKeyboardButton,
        InlineKeyboardMarkupRowBuilder, InlineKeyboardMarkupBuildOptions>
    {
        ...
        protected override IEnumerable<IEnumerable<InlineKeyboardButton>> DeconstructMarkup(
            InlineKeyboardMarkup keyboardMarkup)
        {
            return keyboardMarkup.InlineKeyboard;
        }

        protected override InlineKeyboardMarkup BuildMarkup(
            IEnumerable<IEnumerable<InlineKeyboardButton>> markupKeyboard,
